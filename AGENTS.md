...
- Send a summary to Lark. it should include the workflow run link (the run id is in `runner.txt`, and the link is `https://github.com/ShihaoShen-Bot/ShihaoShen-Bot/actions/runs/[RUN_ID]`).
> [!WARNING]
